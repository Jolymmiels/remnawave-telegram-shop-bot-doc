...
1. **New Installation**: Follow the [Setup Instructions](/en/getting-started/setup/)
2. **Configuration**: Learn about [Environment Variables](/en/configuration/variables/)
3. **Payments**: Set up your [Payment Methods](/en/payments/yookassa/)
4. **Administration**: Understand [Admin Commands](/en/admin/commands/)
